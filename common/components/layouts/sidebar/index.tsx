...
export default function Sidebar() {
  ...
  return (
    <div className="fixed bg-white y-0 left-0 transition-all duration-300 flex flex-col md:px-2 md:h-screen md:py-8">
      <Profile />
      <nav>
        <Breakline />
        <div className="hidden md:flex md:flex-col ">
          ...
          <Breakline />
          <SocialMedia list={filterdSocial} title="Social Media" />
        </div>
        <Breakline />
        <Copyright />
      </nav>
